...
**TAs:** 2 teaching assistants (names to be announced) — one pair supports each week's lecturing students

**2026 format:** the course runs as a co-taught seminar. Week 1 is taught by the lecturer (rules, topic map, format, demo lecture); from week 2, 3-4 students teach each weekly topic (one aspect each), rated 0-3 by the lecturer and by peer ratings. The lecturer steps in as a guaranteed fallback whenever quality does not hold, and two TAs support each week's students. The learning cycle is: ask AI to digest and write, understand and use it to work and iterate, then present it to others to communicate.
