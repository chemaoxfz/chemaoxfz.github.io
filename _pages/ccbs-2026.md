...
**TAs:** Wenqin Zhou (zhouwenqin@westlake.edu.cn); Xinyu Wang (wangxinyu68@westlake.edu.cn) — they support every teaching team (office hours to be announced)
...
| -- | :--- | :----------------- | :------------- | ----- |
| 1 | 20260901 (Tue) | **How this course works, and order of magnitude: the physics.** Dimensional analysis, scaling, estimating from constraints, energy and motion, heat and diffusion, t ≈ x²/κ, null models | [how this course works]({{ '/assets/ccbs/2026fall/intro.html' | relative_url }}) · [core (full)]({{ '/assets/ccbs/2026fall/lecture01-core.html' | relative_url }}) · [exposition]({{ '/assets/ccbs/2026fall/lecture01-exposition.html' | relative_url }}) · [extension example]({{ '/assets/ccbs/2026fall/lecture01-extension.html' | relative_url }}) · [audience extension]({{ '/assets/ccbs/2026fall/lecture01-audience-extension.html' | relative_url }}) · [lineage]({{ '/assets/ccbs/2026fall/lecture01-lineage.html' | relative_url }}) | lecturer-taught |
| 2 | 20260903 (Thu) | **From order of magnitude in biology to binding and catalysis.** The cell's ledger and crowding, mixing times, elementary vs composite reactions, the diffusion-limited on-rate derived, the catalytic bottleneck | [core (full)]({{ '/assets/ccbs/2026fall/lecture02-core.html' | relative_url }}) · [exposition]({{ '/assets/ccbs/2026fall/lecture02-exposition.html' | relative_url }}) · [lineage]({{ '/assets/ccbs/2026fall/lecture02-lineage.html' | relative_url }}) · [extension example]({{ '/assets/ccbs/2026fall/lecture02-extension.html' | relative_url }}) · [audience extension]({{ '/assets/ccbs/2026fall/lecture02-audience-extension.html' | relative_url }}) | lecturer-taught |
| 3 | 20260908 (Tue) | **From reactions to systems: how biochemical behavior emerges.** Reactant, product and change vectors; flux and addition-removal views; fast-binding reductions in gene expression and metabolism; conserved signaling pools; growth dilution; the stability handoff | [core (full)]({{ '/assets/ccbs/2026fall/lecture03-core.html' | relative_url }}) · [exposition]({{ '/assets/ccbs/2026fall/lecture03-exposition.html' | relative_url }}) · [lineage]({{ '/assets/ccbs/2026fall/lecture03-lineage.html' | relative_url }}) | lecturer-taught |
| 4 | 20260910 (Thu) | **Dynamics: from simulations to possible behaviors.** Addition-removal crossings, bistable memory, saddle-node bifurcations, the biological toggle, dimension, Jacobian and Hurwitz stability, state and energy, chemical realizability | [core (full)]({{ '/assets/ccbs/2026fall/lecture04-core.html' | relative_url }}) | students present, lecturer-backed |
...
| What | Weight | When |
| :--- | :--- | :--- |
| **Teach at least one lecture**, alone or in a team of up to 3 students. Sign up by pull request to the [submissions repo](https://github.com/chemaoxfz/ccbs-2026-submissions). Additional lectures are voluntary and earn extra credit. | 40 | required sign-up closes Thu 2026-09-03 |
