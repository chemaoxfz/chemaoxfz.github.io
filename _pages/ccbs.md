...
|  10    |  20251113  | Combinatorial regulation and promiscuous interactions in cell signaling and cell fate decisions, also ultrasensitivity in ligand-receptor binding. ROP as a way for holistic analysis, three archetypal behaviors in a binding reaction. Holistic analysis solving the above problems. Behavior in ROP as trajectory through regimes. Computation of binding-catalysis networks - homotopy continuation.   | (material) | (hw) | [written note](https://chemaoxfz.github.io/assets/ccbs/2025fall/lecture10/202509-CCBS-lecture-notes-10-computation-biomachin_0_1763000567235.pdf); (scribe note) |
